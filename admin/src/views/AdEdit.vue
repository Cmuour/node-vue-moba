   ...
   <div>
      ...
      <el-form label-width="120px" @submit.native.prevent="save">
         ...
         <el-form-item label="广告">
            <el-button @click="model.advertising.push({})">
               <i class="el-icon-plus"></i> 添加广告位
            </el-button>
            <el-row type="flex" style="flex-wrap:wrap;justify-content:space-between">
               <el-col
                  style="margin-top:1rem;border:1px solid #ccc;padding:1rem;flex:0 0 49%"
                  :md="12"
                  v-for="(item, i) in model.advertising"
                  :key="i"
               >
                  <el-form-item label="商家">
                     <el-input v-model="item.title"></el-input>
                  </el-form-item>
                  <el-form-item label="跳转地址" style="margin-top:1rem;">
                  ...
                  <el-form-item style="display:flex;align-items:center;justify-content:center;">
                     <el-button size="small" type="danger" @click="model.advertising.splice(i,1)">删除</el-button>
                  </el-form-item>
               </el-col>
            </el-row>
         </el-form-item>
