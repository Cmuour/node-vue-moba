module.exports = app => {
  ...
  const Hero = require('../../moduls/Hero')
  ...
  router.get('/articles/:id', async (req,res) => {
    ...
    const correlation = await Article.find().where({
      categories: {$in: data.categories}
    }).limit(2)
    res.send({data,correlation})
  })
